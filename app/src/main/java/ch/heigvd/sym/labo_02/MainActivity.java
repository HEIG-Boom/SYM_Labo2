...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asynchronousBtn.setOnClickListener((v) -> {
            Intent intent = new Intent(this, ch.heigvd.sym.labo_02.AsynchronousActivity.class);
            this.startActivity(intent);
        });

        compressedBtn.setOnClickListener((v) -> {
            Intent intent = new Intent(this, ch.heigvd.sym.labo_02.CompressedActivity.class);
            this.startActivity(intent);
        });

        delayedBtn.setOnClickListener((v) -> {
            Intent intent = new Intent(this, ch.heigvd.sym.labo_02.DelayedActivity.class);
            this.startActivity(intent);
        });

        graphQLBtn.setOnClickListener((v) -> {
            Intent intent = new Intent(this, ch.heigvd.sym.labo_02.GraphQLActivity.class);
            this.startActivity(intent);
        });

        objectBtn.setOnClickListener((v) -> {
            Intent intent = new Intent(this, ch.heigvd.sym.labo_02.ObjectActivity.class);
            this.startActivity(intent);
        });
    }
}
